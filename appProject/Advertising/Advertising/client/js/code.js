...
/**
 * checks if the days in the message are match the real day.
 */
...
/**
 * Responsible for the running of adverts.
 */
...
/**
 * Check if the time of the messages match to the real time.
 */
