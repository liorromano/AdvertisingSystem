/**
 * The Server of our app.
 * Responsible to bring the data or sending data to the mongo db.
 * And handle a client that connects to the server.
 */
...
/**
 * Updates a current message in the db.
 */
